...
<!--
**Artem-229/Artem-229** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
- Командный проект в рамках хакатона Hack&Chanhe. Было разработано AI-решение для прогноза доходов клиентов и формирования персональных рекомендаций по финансовым продуктам.
  🔗 **Репозиторий:** [Artem-229/Hackaton-Alfa](https://github.com/Artem-229/Hackaton-Alfa)
  Роль: Backend разработчик



- Личный проект на основе проекта решения хакатона Альфа-будущее
  🔗 Репозиторий: [Artem-229/ai-copilot](https://github.com/Artem-229/ai-copilot) *(в разработке)*
  Роль:
